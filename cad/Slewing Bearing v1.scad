...
// ==========================================================================
ring_gap = 0.3;          // Total gap between inner and outer rings
axle_clearance = 0.45;   // INCREASED: More slack to reduce spike friction
...
// Restored countersinks for inner rings
...
// Restored countersinks for outer rings
