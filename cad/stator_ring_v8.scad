...
// Top Cable Routing Hole (SUBTRACTIVE)
top_routing_length    = 34;   
top_routing_thickness = 37;    
top_routing_offset    = -16;   // Negative pushes it through center to the Top
top_routing_width     = 16.8; 
top_routing_x_offset  = 10;    
top_routing_y_offset  = 0;    
top_routing_z_offset  = 0;    

// Bottom Cable Routing Hole (SUBTRACTIVE)
bottom_routing_length    = 19;   
bottom_routing_thickness = 20;    // Shortened to avoid the lead pellet compartment
bottom_routing_offset    = 42;    // Ends safely at R=42 (Pellet box starts at 48)
bottom_routing_width     = 16.8; 
bottom_routing_x_offset  = 47;    
bottom_routing_y_offset  = 23;    
...
strut_hole_length   = 24;  
strut_hole_width    = 4;  
strut_hole_height   = 24;  
strut_hole_dist     = 28;  
strut_hole_angle    = 210; 
strut_hole_x_offset = 0;   
