...
bno055_mount_rot       = 210;   // Targets the bottom left strut
...
difference() {
    union() {
        ...
        linear_extrude(height = webbing_depth, center = true) {
            union() {
                ...
                BraceSegment(210, bno055_brace_length, bno055_brace_thickness, bno055_brace_offset);
            }
        }
    ...
    linear_extrude(height = bno055_window_width, center = true) {
        BraceSegment(210, bno055_window_length, bno055_window_thickness, bno055_window_offset);
    }
    // BNO055 Mounting Holes
    rotate([0, 0, bno055_mount_rot]) {
